...
CREATE INDEX IF NOT EXISTS idx_ip_visits_ip ON ip_visits(ip);

CREATE INDEX IF NOT EXISTS idx_ip_visits_user_id ON ip_visits(user_id);

CREATE INDEX IF NOT EXISTS idx_ip_visits_visit_type ON ip_visits(visit_type);

CREATE INDEX IF NOT EXISTS idx_applications_user_id ON applications(user_id);

CREATE INDEX IF NOT EXISTS idx_applications_status ON applications(status);

DROP INDEX IF EXISTS idx_applications_airtable_record_id;

CREATE UNIQUE INDEX IF NOT EXISTS idx_applications_airtable_record_id ON applications(airtable_record_id) WHERE airtable_record_id IS NOT NULL;

CREATE INDEX IF NOT EXISTS idx_applications_applicant_email ON applications(applicant_email);

CREATE INDEX IF NOT EXISTS idx_applications_applicant_slack_id ON applications(applicant_slack_id);

CREATE INDEX IF NOT EXISTS idx_applications_applicant_hca_id ON applications(applicant_hca_id);

CREATE INDEX IF NOT EXISTS idx_orders_user_id ON orders(user_id);

CREATE INDEX IF NOT EXISTS idx_users_hca_id ON users(hca_id);

CREATE INDEX IF NOT EXISTS idx_poster_groups_user_id ON poster_groups(user_id);

CREATE INDEX IF NOT EXISTS idx_poster_groups_campaign_slug ON poster_groups(campaign_slug);

CREATE INDEX IF NOT EXISTS idx_posters_user_id ON posters(user_id);

CREATE INDEX IF NOT EXISTS idx_posters_group_id ON posters(poster_group_id);

CREATE INDEX IF NOT EXISTS idx_posters_campaign_slug ON posters(campaign_slug);

CREATE INDEX IF NOT EXISTS idx_posters_status ON posters(verification_status);

CREATE UNIQUE INDEX IF NOT EXISTS idx_posters_qr_code_token ON posters(qr_code_token);

CREATE UNIQUE INDEX IF NOT EXISTS idx_posters_referral_code ON posters(referral_code);

CREATE INDEX IF NOT EXISTS idx_poster_scans_poster_id ON poster_scans(poster_id);
